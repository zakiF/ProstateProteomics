...
dplyr::filter(df_meta_f2, mrn == "[REDACTED_MRN]") %>% select(mrn, HCI_cID, txt_stat, txt_stat_ordered)
dplyr::filter(patient_patterns, mrn == "[REDACTED_MRN]") %>% as.data.frame()
...
# dplyr::filter(df_meta_f4, mrn == "[REDACTED_MRN]") %>% select(mrn, HCI_cID, txt_stat, txt_stat_ordered)
# dplyr::filter(patient_patterns, mrn == "[REDACTED_MRN]") %>% as.data.frame()
